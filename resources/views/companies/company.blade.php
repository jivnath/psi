					...
					<div class="row">
									...
									<div class="box-body">
										<div class="input-group">
											...
											<input type="text" placeholder="Company Name"
												class="form-control" name="company_name"><br>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Contact No."
												class="form-control" name="company_contact"><br>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Section Name"
												class="form-control" name="section_name"><br>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Contact No."
												class="form-control" name="section_contact"><br>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Team Leader"
												class="form-control" name="section_leader"><br>
										</div>
										<br> <label for="section"><h4>
												<b>Sub-Section</b>
											</h4></label>
										<div class="input-group">
											...
											<input type="text" placeholder="Sub-section Name"
												class="form-control" name="subsection_name"><br>
										</div>
						...
						<div class="col-md-12" id="forExisting" style="display: none">
							<div class="box box-info">
								<div class="box-body">
									<form class="form-group">
										<label for="company"><h4>
												<b>Company</b>
											</h4></label> <select class="form-control"
											name="allCompanies" style="width: 75%">
										...
										<br> <label for="section"><h4>
											...
											</h4></label> <select class="form-control input-shorter"
											name="allSections">
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Section Name"
												class="form-control" name="existing_section_name"><br>
										</div>
										<br>
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Contact No."
												class="form-control" name="existing_section_contact"><br>
										</div>
										<br>
										<div class="input-group">
											<div class="input-group-addon">
											...
											<input type="text" placeholder="Address" class="form-control"
												name="existing_section_address"><br>
										</div>
										<br>
										<div class="input-group">
											<div class="input-group-addon">
											...
											<input type="text" placeholder="Team Leader"
												class="form-control" name="existing_section_leader"><br>
										</div>
										<br> <label for="section"><h4>
												<b>Sub-Section</b>
												<button style="margin-left: 20px"
										...
										<div class="input-group">
											...
											<input type="text" placeholder="Sub-section Name"
												class="form-control" name="existing_subsection_name"><br>
										</div>
										<br> <input type="submit" value="Submit"
											class="btn btn-success">

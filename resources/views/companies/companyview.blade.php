                                                            ...
                                                            @foreach($section as $index2=>$subsection)
                                                                ...
                                                                @foreach($subsection as $index3)
                                                                    @foreach($index3 as $index4)
                                                                        <tr>
                                                                            @if($increment_val==0)
                                                                                <td class="table_th_fix"
                                                                                    rowspan='{{count($section)+2}}'><i
                                                                                            class="fas fa-mobile-alt"></i> {{$index4['contact_c1']}}
                                                                                    |
                                                                                    <i class="fas fa-location-arrow"></i> {{$index4['address_c1']}} @if($index4['manager'])
                                                                                        |
                                                                                        <i class="fas fa-user"></i> {{$index4['manager']}}@endif
                                                                                </td>
                                                                            @endif

                                                                            <td class="table_th_fix"><i
                                                                                        class="fas fa-mobile-alt"></i> {{$index4['contact_c2']}}
                                                                                |
                                                                                <i class="fas fa-location-arrow"></i> {{$index4['address_c2']}}
                                                                            </td>
                                                                        </tr>
                                                            @endforeach
                                                            @endforeach

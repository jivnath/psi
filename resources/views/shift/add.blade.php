                            ...
                            <div class="col-md-7">
                                <div class="table-responsive">
                                    <table id="dynamic_field" style="width: 100%">
                                        <tr class="form-group">
                                            <td style="padding: 10px"><input type="time" name="start_shift[]" placeholder="Shift Time" class="form-control name_list"
                                                /></td>
                                            <td style="padding: 10px"><input type="time" name="end_shift[]" placeholder="Shift Time" class="form-control name_list"
                                                /></td>

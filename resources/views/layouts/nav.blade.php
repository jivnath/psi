			...
			<div class="container" style="padding: 5px 20px 20px">
				<div class="navbar-header">
					<a class="navbar-brand" href="#"> @auth <img alt="PSI-S"
						id="logo_small" src="/images/logo_small.png"> @else <img
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav mr-auto">
							<li class="nav-item dropdown"><a id="master_data"
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li class="dropdown"><a class="dropdown-toggle dropdown-item"
										href="#" id="navbarDropdown" role="button"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">@lang('nav.Users')</a>
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item"
									...
									<li class="dropdown"><a class="dropdown-toggle dropdown-item"
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item"
												href="{{ route('employees.show') }}">@lang('nav.Employee')</a></li>
											<li><a class="dropdown-item"
												href="{{ route('employee.skill') }}"> Employee Skills</a></li>
											<li><a class="dropdown-item"
												href="{{ route('availability.add') }}"> Employee
													Availability</a></li>
									...
									<li class="dropdown"><a class="dropdown-toggle dropdown-item"
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item"
												href="{{ route('company.details') }}">@lang('nav.Company')</a></li>
											<li><a class="dropdown-item"
												href="{{ route('manageCompanies') }}">Company Manage</a></li>
											<li><a class="dropdown-item" href="{{ route('shift.add') }}">
													Company Shift</a></li>
											<li><a class="dropdown-item"
												href="{{ route('leader.create') }}"> Team Leader </a></li>

										</ul></li>
									<a class="dropdown-item" href="{{ route('manageSkills') }}">
										Skills </a>
							...
							<li class="nav-item dropdown"><a id="shift_management"
								...
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" v-pre> <i class="far fa-clock"></i>
								...
								<div class="dropdown-menu dropdown-menu-left"
									...
									<a class="dropdown-item" href="{{ route('pages.shift') }}">
										Company Shift </a> <a class="dropdown-item"
										href="{{route('sheet.dessert')}}"> Self Sheet </a> <a
										class="dropdown-item" href="#"> Attendance Management </a>
								</div></li>
							<li class="nav-item dropdown"><a id="shift_management"
								class="nav-link dropdown-toggle" href="#" role="button"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" v-pre> <i class="fa fa-line-chart"></i>
								...
								<div class="dropdown-menu dropdown-menu-left"
									...
									<a class="dropdown-item"
										...
										class="fa fa-users" aria-hidden="true"></i> Employee Details </a>
								</div></li>
							<!-- company login as -->
							...
							<li class="nav-item dropdown"><a id="shift_management"
								class="nav-link dropdown-toggle company_default_select" href="#"
								role="button" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false"> <i class="fas fa-sign-in-alt"></i>
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown"><a id="setting"
								class="nav-link dropdown-toggle" href="#" role="button"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" v-pre> <i class="fas fa-cog"></i>
									@lang('nav.Setting') <span class="caret"></span>
							</a>

								<div class="dropdown-menu dropdown-menu-left"
									aria-labelledby="setting">
									<a class="dropdown-item" href="#"> Alert Management </a>
								</div></li>

							<li class="nav-item dropdown"><a id="navbarDropdown"
								class="nav-link dropdown-toggle" href="#" role="button"
								data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" v-pre> <i class="fas fa-user"></i> {{(

        ...
        <div class="col-md-8 offset-md-2">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <img src="{{asset('images/dist/user4-128x128.jpg')}}" alt="user image"
                         class="profile-user-img img-responsive img-circle">
                    <h4 class="box-title"
                        style="color:#004d99;font-weight:bold;font-size:160%;margin-left:3%">{{$name->name}}</h4>
                ...
                <div class="box-body">
                    ...
                    <div style="margin-left:3%;">
                        ...
                        <i class="fas fa-clock" style="color:#004d99;margin-left:80%"
                           ;>{{substr($view->message_date, 0, -3)}}</i>
                    </div>
                    ...
                    <div style="margin-left:3%;">
                        ...
                        <i class="fas fa-clock" style="color:#004d99;margin-left:80%"
                           ;>{{substr($view->response_date, 0, -3)}}</i>
                    </div>
                </div>
            </div>
        </div>

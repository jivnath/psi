...
//   Route::group(['middleware'=>['check.user']], function(){
        Route::group(['middleware' => ['check.primary.company']], function () {
            ...
            Route::prefix('master_data')->group(function () {
                ...
                Route::prefix('employee_availability')->group(function () {  
                ...
                Route::prefix('companies')->group(function () {
                    Route::prefix('company_manage')->group(function () {  
                ...
                Route::prefix('sub-section_shift')->group(function () {
                ...
                Route::prefix('section_manager')->group(function () {

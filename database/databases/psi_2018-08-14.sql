...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2018 at 02:27 PM
...
(1, 'Company 1', NULL, 1, '2018-07-20 11:39:19', '2018-08-13 05:55:26'),
(2, 'Comapny 2', NULL, 2, '2018-07-20 11:39:28', '2018-08-13 05:55:31'),
(3, 'Company 3', 1, 1, '2018-08-01 05:39:02', '2018-08-01 05:39:02'),
(4, 'Company 4', 3, 2, '2018-08-01 05:40:28', '2018-08-12 00:23:01'),
(5, 'Company 5', 2, 1, '2018-08-11 23:56:29', '2018-08-11 23:56:56'),
(7, 'Company 6', NULL, 1, '2018-08-13 05:53:19', '2018-08-13 05:53:19');
...
--
-- Table structure for table `company_time_schadules`
--

CREATE TABLE `company_time_schadules` (
  `id` int(10) UNSIGNED NOT NULL,
...
(2, 1, 1, 1, 1, 1, 1, 1, 1, '2018-08-10 05:40:24', '2018-08-10 05:40:24'),
(3, 1, 1, 1, 1, 1, 1, 1, 1, '2018-08-10 05:40:31', '2018-08-10 05:40:31'),
...
(4, 'Superuser', 'superuser@admin.com', '$2y$10$W/x8232aTatxHsk6Z6E77eaUdqEDGpUKAjMb3D1kfd1EhgMu/sO8m', NULL, '2018-08-12 04:39:47', '2018-08-12 04:39:47');
...
--
-- Indexes for table `company_time_schadules`
--
ALTER TABLE `company_time_schadules`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `company_time_schadules`
--
ALTER TABLE `company_time_schadules`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
